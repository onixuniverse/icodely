    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_image', models.ImageField(blank=True, default=None, null=True, upload_to='lessons/exams/images', verbose_name='Изображение (необязательно)')),
                ('right_answer', models.CharField(max_length=63, verbose_name='Правильный ответ')),
                ('exam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='examination.examination', verbose_name='Тестирование')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='examination.examinationquestion', verbose_name='Вопрос')),
            ],
            options={
                'verbose_name': 'Ответ',
